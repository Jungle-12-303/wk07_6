...
graph LR
    ...
    C16 --> a1[free 16] --> a2[free 16] --> a3[...]
    C32 --> b1[free 32] --> b2[free 32] --> b3[...]
    C64 --> c1[free 64] --> c2[...]
    C128 --> d1[free 128] --> d2[...]
    CBig --> e1[sorted by size]
```

작은 요청은 **상수 시간**에 가까운 속도로 찾는다. glibc의 `ptmalloc`, Google의 `tcmalloc`, jemalloc 등 실제 할당기 대부분이 이 구조를 기본으로 한다.

## Placement Policy — 어떤 free 블록을 고를까
