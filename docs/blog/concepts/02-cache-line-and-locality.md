...
오늘날 대부분의 x86·ARM 프로세서에서 그 크기는 **64바이트**입니다.
...
두 스레드가 **서로 다른 변수**를 쓰더라도 그 두 변수가 **같은 64바이트 라인** 안에 있으면, 한 코어가 쓰는 순간 다른 코어의 캐시에 있는 같은 라인이 무효화됩니다.
